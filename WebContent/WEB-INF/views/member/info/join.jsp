			...
			<div class="padding-lr margin-top-small-space">
	  		<strong class="text-normal text-highlight">나의 계정</strong>
	  		 ...
	  		 <input type="file" class="photo-file-button" id="upload" style="display:none;" name="profile"> 
	     	     	...
	     	     	<div class="padding-lr margin-top-small-space">
	  			<strong class="text-normal text-highlight"><label for="name">아이디</label></strong>
	  			<input	class="acc-text-area" type="button" id="id-check-button" style="height:1.5rem; width:5rem;"
						value="중복확인" />
	  		</div>
	     	<div class="padding-lr margin-top-small-space">
	     		<input id="id-text" type="text" class="acc-text-area" name="id" >	
	     	</div>
	     	...
	     	<div class="padding-lr margin-top-small-space">
	     		<input type="text" class="acc-text-area" name="name" >	
	     	</div>
	     	...
	     	<div class="padding-lr margin-top-small-space">
		     	<div class="padding-lr margin-top-small-space">
	     			...
	     			<input type="text" class="acc-text-area"  name="nickname"  >
	     	</div>
	     	...
	     	<div id="email-area" class="padding-lr margin-top-small-space">
	     		<input type="text" class="acc-text-area"  style="width:6rem;" name="email1"  pattern="^[a-zA-Z0-9]*$"> @ <input type="text" class="acc-text-area"  style="padding-left:0 !important; width:6rem;" name="email2"> 
	     		<select  class="acc-text-area"  style="padding-left:0 !important; width:5rem;" name="email_select"  onchange="checkemailaddy();"> 
	     	...
	     	<div class="padding-lr margin-top-small-space">
	     		<input type="tel" class="acc-text-area" name="phone"  placeholder="'-' 제외하고 숫자만 입력하세요" pattern="^[0-9]{10,11}$">
	     	</div>	
...
<!-- 	  	------------------- 주소 API ------------------------I -->
<div class="padding-lr margin-top-small-space">
<input  type="text" id="sample6_postcode" placeholder="우편번호" class="acc-text-area margin-top-small-space-space"  style="width:27.3%;" name="postcode">
<input   type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="acc-text-area" style="width:50%;"><br>
<input   type="text" id="sample6_address" class="acc-text-area margin-top-small-space-space" placeholder="기본주소"  name="address1">
<input  type="text" id="sample6_address2" class="acc-text-area margin-top-small-space-space" placeholder="상세주소" name="address2">
...
<!-- 	  	------------------- 주소 API ------------------------I -->
	     	...
	     	<div class="padding-lr margin-top-small-space">
	  			<strong class="text-normal text-highlight">&nbsp;&nbsp;<label for="newpasswd">비밀번호</label></strong>
	  		</div>
			<div class="padding-lr margin-top-small-space">
		     	<input  type="password" class="acc-text-area" name="password" pattern="^(?=.*[a-zA-Z])(?=.*[!@#$%^*+=-])(?=.*[0-9]).{8,}$">
		     	<input  type="password" class="acc-text-area margin-top-small-space-space" pattern="^(?=.*[a-zA-Z])(?=.*[!@#$%^*+=-])(?=.*[0-9]).{8,}$">
			</div>
	     	<div class="padding-lr text-center flex-row margin-lr-no margin-top-space card-below">

	     			<input id="submit-Button" type="submit" class="btn" value="저장"> 
	     <a class="back">
		...
		var photoButton = document.querySelector(".photo-button");
		  ...
		  photoButton.onclick = function() {
			...
			idCheckButton.onclick = function() {
				...
				request.open("GET", "idcheck?id=" + memberId);
				request.send();
