...
$(document).ready(function(){
	var myKey = "djuNVfIulkkmHGIbIjxpnQ"; // sweet tracker에서 발급받은 자신의 키 넣는다.
...
<button id="myButton1" class="btn margin-top-space font-m-size" style="width:8rem !important;">택배 조회하기 </button>
<button id="myButton2" class="btn margin-top-space font-m-size" style="width:3rem !important;">닫기 </button>
</div>
<br/>
<br/>
<div>
