...
@WebServlet("/Category/productInfo/seller/review/answerReview")
public class answerReviewController extends HttpServlet 
{
	@Override
...
//		request.setAttribute("list", list);
		...
		ApplicationContext applicationContext = ServletUtil
	      ...
	      container.render("Category.productInfo.seller.review.answerReview", servletRequest);
