...
@WebServlet("/Board/messageboard/board_best")
public class BestBoardController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Board> list = boardDao.bestgetList(page,categortId);
		...
		RequestDispatcher dispatcher = 
				request.getRequestDispatcher("/WEB-INF/views/Board/messageboard/board_best.jsp");
