...
@WebServlet("/Board/messageboard/board_baby")
public class BabyBoardController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
				request.getRequestDispatcher("/WEB-INF/views/Board/messageboard/board_baby.jsp");
