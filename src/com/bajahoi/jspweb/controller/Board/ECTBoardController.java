...
@WebServlet("/Board/messageboard/board_ect")
public class ECTBoardController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = 
				request.getRequestDispatcher("/WEB-INF/views/Board/messageboard/board_ect.jsp");
